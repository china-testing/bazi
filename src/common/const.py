...
INDEX_JIAN_CHU_TUPLE = dict(enumerate(JIAN_CHUS))
...
SHANG_GUAN_DATA = {"火": "伤尽。", "金": "要见官", "木": "官要旺", "土": "伤尽。", "水": "伤官木也要土"}
...
YMCS = ["十一", "十二", "正", "二", "三", "四", "五", "六", "七", "八", "九", "十"]
RMCS = [
    "初一",
    "初二",
    "初三",
...
ZHI_3_HE_DATA = {"申子辰": "水 寅", "巳酉丑": "金 亥", "寅午戌": "火 申", "亥卯未": "木 巳"}
GONG_HE_DATA = {
    "申辰": "子",
    "巳丑": "酉",
    "寅戌": "午",
...
ZHI_XING_DATA = {
    ...
    (
        "子",
        "卯",
    ): "子刑卯　卯刑子 无礼之刑 女命见之，尤为不良 生旺主人威肃，面无和气，气强性暴，太察不容；死绝则侮慢忽略，狭劣刻剥，少孝悌，害妻子，吴越六亲。入贵格则多掌兵权，不利近侍；位居不久；入贱格则悖凶暴，多招刑祸。",
}
...
JI_HOUR_DATA = {"春": "乙卯", "夏": "丙午", "秋": "庚申", "冬": "辛酉"}
YUE_HOUR_DATA = {
    "正": "亥",
    "二": "子",
    "三": "丑",
